...
#SBATCH --output=/mnt/polished-lake/home/annabelma/disentangling-computation-from-cot/probing/logs/probe_training_%j.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python /mnt/polished-lake/home/annabelma/disentangling-computation-from-cot/probing/train_probe.py --config "$CONFIG_FILE" --mode "$MODE"
